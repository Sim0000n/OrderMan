...
class SellerOrderList extends React.Component {
    ...
    async getData() {
        ...
        let that = this;
        fetch(`http://localhost:8081/api/seller/getOrders`, {
            method: 'POST',
        ...
        const row = (rowData, sectionID, rowID) => {
            ...
            return (
                ...
                <div>
                    ...
                    <Link href="/seller/orders/[val]" as={`/seller/orders/${obj.order_id}`}>
                        <a style={{ width: "100%" }}>
                            <Card>
                                <Card.Header
                            ...
                            <Card.Footer content={"用户名:"+obj.user_name} extra={"订单金额：" + obj.spend} />
                        </a>
                    </Link>
                </div>
            );
